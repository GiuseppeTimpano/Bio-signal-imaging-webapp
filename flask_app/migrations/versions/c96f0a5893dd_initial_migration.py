...
Revision ID: c96f0a5893dd
Revises: 
Create Date: 2023-05-17 23:10:17.310942
...
def upgrade():
    ...
    op.create_table('3ddicom',
    sa.Column('dicom_id', sa.Integer(), nullable=False),
    sa.Column('num_slice', sa.Integer(), nullable=False),
